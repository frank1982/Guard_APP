...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(application: UIApplication, didFinishLaunchingWithOptions launchOptions: [NSObject: AnyObject]?) -> Bool {
        ...
        //print("本地product数量:\(Dao.countLocalProductNum())")
        
        var updateTime=_netDao.getUpdateTime()
        //print("服务端最新updateTime:\(updateTime)")
        var localUpdateTime=Dao.getLocalUpdateTime()
        //print("本地最新updateTime:\(localUpdateTime)")
        ...
        }else if localUpdateTime?.timeIntervalSinceDate(updateTime!) < 0{//本地数据旧
    ...
    //down product from server
    func downProduct(){//同步
        
        //print("downProduct()")
        var tmp:NSMutableArray!
        tmp = _netDao.downProduct()
